...
class BlogPostPage extends React.Component<Props, State>{
    ...
    callPostInfo = async () => {
        try {
            const { data } = await axios.post(`http://127.0.0.1:8080/api/get/post`, { info:{PostID: Number(this.props.match.params.post_id)} })
                ...
                <div className="post-page">
                    ...
                    <div className="content-wrap">
                        <div className="title-form">
                            ...
                            <div className="alis-wrap">{this.state.post.SubTitle}</div>
